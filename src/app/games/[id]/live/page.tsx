  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      <div className="mx-auto max-w-[1680px] p-2 md:p-3">
        <div className="grid gap-3 2xl:grid-cols-[1.04fr_0.96fr]">
          <div className="min-w-0 space-y-3">
            <div className="overflow-hidden rounded-[28px] border border-white/10 bg-gradient-to-b from-white/8 to-white/[0.03] shadow-[0_10px_40px_rgba(0,0,0,0.35)]">
              ...
              <div className="px-3 py-3 md:px-4">
                ...
                <div className="mt-3 grid gap-2 xl:grid-cols-[0.92fr_1.08fr]">
            ...
            <div className="grid gap-3 xl:grid-cols-[1.1fr_0.9fr]">
              <div className="min-w-0 rounded-[28px] border border-white/10 bg-white/5 p-3 md:p-4">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <button
                          ...
                          disabled={game?.status === "finished"}
                          className="rounded-2xl bg-emerald-700 px-2 py-3 text-sm font-extrabold disabled:opacity-50"
                        >
                          2分進
                        </button>
                        <button
                          ...
                          disabled={game?.status === "finished"}
                          className="rounded-2xl bg-white/10 px-2 py-3 text-sm font-bold disabled:opacity-50"
                        >
                          2分鐵
                        </button>
                        <button
                          ...
                          disabled={game?.status === "finished"}
                          className="rounded-2xl bg-slate-700 px-2 py-3 text-sm font-bold disabled:opacity-50"
                        >
                          籃板
                        </button>
                        ...
                        <button
                          ...
                          disabled={game?.status === "finished"}
                          className="rounded-2xl bg-blue-700 px-2 py-3 text-sm font-bold disabled:opacity-50"
                        >
                          助攻
                        </button>
                        ...
                        <button
                          ...
                          disabled={game?.status === "finished"}
                          className="rounded-2xl bg-orange-700 px-2 py-3 text-sm font-bold disabled:opacity-50"
                        >
                          犯規
                        </button>
                      </div>
                ...
                <div className="rounded-[28px] border border-white/10 bg-white/5 p-3 md:p-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <button
                      ...
                      disabled={game?.status === "finished"}
                      className="rounded-2xl bg-orange-600 px-3 py-3 text-base font-extrabold disabled:opacity-50"
                    >
                      +1
                    </button>
                    <button
          ...
          <div className="min-w-0">
            <div className="rounded-[28px] border border-white/10 bg-white/5 p-3 md:p-4">
              <div className="mb-3 flex items-center justify-between gap-2">
                <div>
                  <div className="text-sm font-semibold">手機橫向重點區</div>
                  <div className="text-[11px] text-white/50">
                    這區保留較大操作區，讓橫向時更容易點
                  </div>
                </div>
                <div className="rounded-full bg-white/10 px-3 py-1.5 text-[11px] font-bold text-white/70">
                  {selectedPlayer
                    ? `目前：#${selectedPlayer.number ?? "-"} ${selectedPlayer.name}`
                    : "未選球員"}
                </div>
              </div>
              ...
              <div className="grid gap-3 lg:grid-cols-[0.92fr_1.08fr]">
                <div className="space-y-3">
                      ...
                      {onCourtPlayers.slice(0, 5).map((p) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="mt-1 truncate text-[11px]">{p.name}</div>
                            <div
                              className={`mt-1 text-[10px] font-bold ${
                                selected ? "text-emerald-200" : "text-white/45"
                              }`}
                            >
                              {selected ? "紀錄中" : "點選"}
                            </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/25 p-3">
                    <div className="mb-2 text-[11px] font-semibold text-white/50">
                      快速比分檢視
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      <div className="rounded-2xl bg-white/5 p-3 text-center">
                        <div className="text-[11px] text-white/45">{game?.teamA || "我方"}</div>
                        <div className="mt-1 text-4xl font-black">{teamScore.scoreA}</div>
                      </div>
                      <div className="rounded-2xl bg-white/5 p-3 text-center">
                        <div className="text-[11px] text-white/45">{game?.teamB || "對手"}</div>
                        <div className="mt-1 text-4xl font-black">{teamScore.scoreB}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="rounded-2xl border border-white/10 bg-black/25 p-3">
                    <div className="mb-2 text-[11px] font-semibold text-white/50">高頻事件</div>
                    <div className="grid grid-cols-3 gap-2">
                      <button
                        onClick={() => addEvent("fg2_made", "A")}
                        disabled={game?.status === "finished"}
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/25 p-3">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      <button
                        onClick={() => addEvent("ft_made", "B")}
                        disabled={game?.status === "finished"}
                        className="rounded-2xl bg-orange-600 px-2 py-4 text-sm font-extrabold disabled:opacity-50"
                      >
                        對手+1
                      </button>
                      <button
                      ...
                      <button
                        onClick={undoLastEvent}
                        className="rounded-2xl bg-red-500/20 px-2 py-4 text-sm font-bold text-red-300"
                      >
                        復原
                      </button>
                    </div>
