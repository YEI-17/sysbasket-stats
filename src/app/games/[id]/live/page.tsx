...
export default function LiveGamePage() {
  ...
  return (
  <div className="min-h-screen bg-neutral-950 p-2 text-white md:p-3">
      ...
      <div className="grid gap-3 xl:grid-cols-[1.08fr_0.92fr]">
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          className="w-full rounded-xl px-1 py-2.5 text-center"
                        >
        ...
        <div className="space-y-3 min-w-0">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-3 md:p-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                disabled={game?.status === "finished"}
                className="rounded-2xl bg-orange-600 px-3 py-3.5 text-base font-extrabold disabled:opacity-50 sm:text-lg"
              >
                +1
              </button>
              <button
            ...
            <div className="border-b border-white/10 px-4 py-4 md:px-5">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="mt-1 truncate text-xl font-extrabold md:text-2xl">
              ...
              <div className="rounded-[28px] border border-white/10 bg-black/35 p-4">
                <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
                  <div className="min-w-0 text-left">
                    ...
                    <div className="mt-1 truncate text-lg font-bold md:text-xl">
                      {game?.teamA || "我方"}
                    </div>
                    <div className="mt-2 text-5xl font-black leading-none md:text-6xl">
                      {teamScore.scoreA}
                    </div>
                  </div>

                  <div className="text-center">
                    <div className="text-sm font-bold text-white/75 md:text-base">
                      {getQuarterLabel(clock?.quarter ?? 1)}
                    </div>
                    <div className="mt-1 text-4xl font-black tracking-wider md:text-5xl">
          ...
          <button
            ...
            className="w-full rounded-3xl bg-rose-700 px-4 py-4 text-base font-extrabold transition hover:bg-rose-600 disabled:opacity-50"
          >
            {game?.status === "finished"
              ? "比賽已結束"
              : endingGame
